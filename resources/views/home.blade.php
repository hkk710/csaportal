...
<div id="wrapper">
	...
	<div id="three-column" class="container">
		...
		<div id="tbox2"> <span class="icon icon-food"></span>
			...
			<a href="#" class="button">Learn More</a> </div>
		<div id="tbox3"> <span class="icon icon-qrcode"></span>
	...
	<div id="page" class="container">
		<div id="content">
			...
			<p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Pellentesque tristique ante ut risus.</p>
			<ul class="style1">
				<li class="first"> <a href="#" class="image image-left"><img src="img/pic01.jpg" alt="" /></a>
				...
				<li> <a href="#" class="image image-left"><img src="img/pic02.jpg" alt="" /></a>
					<h3>Sagittis diam dolor sit amet</h3>
					<p><a href="#">In posuere eleifend odio. Quisque semper augue mattis wisi. Pellentesque viverra vulputate enim. Aliquam erat volutpat.</a></p>
				</li>
				<li> <a href="#" class="image image-left"><img src="img/pic03.jpg" alt="" /></a>
